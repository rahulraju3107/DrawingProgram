...
namespace SplashKitSDK
{
  public static class SplashKit
  {
    ...
    public static Point2D ClosestPointOnLine(Point2D fromPt, Point2D point2D, Line l)
    {
      __sklib_point_2d __skparam__from_pt;
      __sklib_line __skparam__l;
      __sklib_point_2d __skreturn;
    ...
    public static float LineLength(Point2D pt, Point2D point2D, Line l)
    {
      __sklib_line __skparam__l;
      float __skreturn;
      __skparam__l = __skadapter__to_sklib_line(l);
    ...
    public static float PointLineDistance(float x, float y, float _endX, Point2D pt, Line l)
    {
      __sklib_point_2d __skparam__pt;
      __sklib_line __skparam__l;
      float __skreturn;
    ...
    public static int WindowY(Window wnd)
    {
      ...
      return __skadapter__to_int(__skreturn);
        ...
        internal static float LineLength(Point2D pt, Point2D point2D1, Point2D point2D2)
        {
